...
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: prada_casting, rate: 1200)
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: lemaire_job, rate: 1400)
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: wooyungmi_option, rate: 1000)
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: chanel_casting, rate: 1300)
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: dior_job, rate: 1500)
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: louis_vuitton_option, rate: 1100)
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: gucci_casting, rate: 1200)
...
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: balenciage_casting, rate: 1250)
...
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: burberry_casting, rate: 1275)
...
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: lemaire_casting, rate: 1300)
...
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: saint_laurent_casting, rate: 1250)
...
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: balenciage_casting, rate: 1120)
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: lemaire_job, rate: 1490)
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: chanel_casting, rate: 1260)
Connection.create!(model_agency_profile: model_development, agency_id: success.id, listing: burberry_casting, rate: 1320)
