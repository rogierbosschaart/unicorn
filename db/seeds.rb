...
Connection.create!(model_agency_profile: profile_3, agency_id: success.id, listing: prada_casting, rate: 1200)
...
Connection.create!(model_agency_profile: profile_6, agency_id: success.id, listing: balenciage_casting, rate: 1210)
Connection.create!(model_agency_profile: profile_7, agency_id: success.id, listing: lemaire_casting, rate: 1275)
Connection.create!(model_agency_profile: profile_8, agency_id: success.id, listing: saint_laurent_casting, rate: 1400)
Connection.create!(model_agency_profile: profile_9, agency_id: success.id, listing: burberry_casting, rate: 1330)
Connection.create!(model_agency_profile: profile_10, agency_id: success.id, listing: wooyungmi_option, rate: 1150)
Connection.create!(model_agency_profile: profile_11, agency_id: success.id, listing: louis_vuitton_option, rate: 1380)
Connection.create!(model_agency_profile: profile_12, agency_id: success.id, listing: saint_laurent_option, rate: 1280)
Connection.create!(model_agency_profile: profile_13, agency_id: success.id, listing: fendi_option, rate: 1110)
Connection.create!(model_agency_profile: profile_14, agency_id: success.id, listing: gucci_option, rate: 1250)
Connection.create!(model_agency_profile: profile_15, agency_id: success.id, listing: lemaire_job, rate: 1500)
Connection.create!(model_agency_profile: profile_16, agency_id: success.id, listing: dior_job, rate: 1590)
Connection.create!(model_agency_profile: profile_17, agency_id: success.id, listing: chanel_job, rate: 1440)
Connection.create!(model_agency_profile: profile_18, agency_id: success.id, listing: hermes_job, rate: 1370)
Connection.create!(model_agency_profile: profile_19, agency_id: success.id, listing: versace_job, rate: 1410)
Connection.create!(model_agency_profile: profile_20, agency_id: success.id, listing: prada_job, rate: 1550)
Connection.create!(model_agency_profile: profile_21, agency_id: success.id, listing: dior_option, rate: 1200)
Connection.create!(model_agency_profile: profile_22, agency_id: success.id, listing: fendi_job, rate: 1460)
Connection.create!(model_agency_profile: profile_23, agency_id: success.id, listing: burberry_casting, rate: 1350)
Connection.create!(model_agency_profile: profile_24, agency_id: success.id, listing: saint_laurent_casting, rate: 1240)
Connection.create!(model_agency_profile: profile_25, agency_id: success.id, listing: gucci_casting, rate: 1390)
Connection.create!(model_agency_profile: profile_26, agency_id: success.id, listing: lemaire_casting, rate: 1175)
Connection.create!(model_agency_profile: profile_27, agency_id: success.id, listing: balenciage_casting, rate: 1125)
Connection.create!(model_agency_profile: profile_28, agency_id: success.id, listing: chanel_casting, rate: 1340)
Connection.create!(model_agency_profile: profile_29, agency_id: success.id, listing: hermes_job, rate: 1530)
Connection.create!(model_agency_profile: profile_30, agency_id: success.id, listing: louis_vuitton_option, rate: 1190)
Connection.create!(model_agency_profile: profile_31, agency_id: success.id, listing: wooyungmi_option, rate: 1360)
