...
Connection.create!(model_agency_profile: model_img, agency_id: img.id, listing: prada_casting, rate: 1250)
Connection.create!(model_agency_profile: model_bella, agency_id: bella.id, listing: hermes_job, rate: 1380)
Connection.create!(model_agency_profile: model_success, agency_id: success.id, listing: louis_vuitton_option, rate: 1080)
Connection.create!(model_agency_profile: model_bella, agency_id: bella.id, listing: balenciage_casting)
Connection.create!(model_agency_profile: model_img, agency_id: img.id, listing: lemaire_job, rate: 1490)
Connection.create!(model_agency_profile: model_bella, agency_id: bella.id, listing: chanel_casting)
Connection.create!(model_agency_profile: model_img, agency_id: img.id, listing: burberry_casting)
Connection.create!(model_agency_profile: model_bella, agency_id: bella.id, listing: saint_laurent_option)
Connection.create!(model_agency_profile: model_success, agency_id: success.id, listing: gucci_option, rate: 1040)
Connection.create!(model_agency_profile: model_img, agency_id: img.id, listing: fendi_option)
